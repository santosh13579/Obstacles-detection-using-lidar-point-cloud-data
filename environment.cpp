...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
  ...
  //pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud=inputCloud;
  inputCloud=pointProcessorI->FilterCloud(inputCloud, 0.3 , Eigen::Vector4f (-10.0, -5.0, -2.0, 1),Eigen::Vector4f ( 30.0, 8.0, 1.0, 1));
